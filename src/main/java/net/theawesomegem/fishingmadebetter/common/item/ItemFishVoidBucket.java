...
public class ItemFishVoidBucket extends Item {
    public ItemFishVoidBucket(){
        super();

        this.maxStackSize=1;
        this.setCreativeTab(FMBCreativeTab.instance);
        this.setRegistryName("fish_void_bucket");
        this.setTranslationKey(ModInfo.MOD_ID+".fish_void_bucket");
    }
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
        ...
        if(voidCount < 25) {
            playerIn.sendMessage(new TextComponentTranslation("notif.fishingmadebetter.fish_void_bucket.small_void"));
            return new ActionResult<>(EnumActionResult.FAIL, itemstack);
        }*/
        ...
        playerIn.setHeldItem(handIn, new ItemStack(ItemManager.VOID_BUCKET));
    ...
    public static ItemStack getItemStack(String fishId) {
        ItemStack itemStack = new ItemStack(ItemManager.FISH_VOID_BUCKET, 1);
