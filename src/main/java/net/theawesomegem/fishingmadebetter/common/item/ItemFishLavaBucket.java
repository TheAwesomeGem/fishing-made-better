...
public class ItemFishLavaBucket extends Item {
    public ItemFishLavaBucket(){
        super();

        this.maxStackSize=1;
        this.setCreativeTab(FMBCreativeTab.instance);
        this.setRegistryName("fish_lava_bucket");
        this.setTranslationKey(ModInfo.MOD_ID+".fish_lava_bucket");
    }
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
        ...
        if(material != MaterialLiquid.LAVA) {
            playerIn.sendMessage(new TextComponentTranslation("notif.fishingmadebetter.fish_lava_bucket.only_lava"));
        ...
        if(lavaCount < 25) {
            playerIn.sendMessage(new TextComponentTranslation("notif.fishingmadebetter.fish_lava_bucket.small_lava"));
            return new ActionResult<>(EnumActionResult.FAIL, itemstack);
        }
        ...
        playerIn.setHeldItem(handIn, new ItemStack(Items.LAVA_BUCKET));
    ...
    public static ItemStack getItemStack(String fishId) {
        ItemStack itemStack = new ItemStack(ItemManager.FISH_LAVA_BUCKET, 1);
