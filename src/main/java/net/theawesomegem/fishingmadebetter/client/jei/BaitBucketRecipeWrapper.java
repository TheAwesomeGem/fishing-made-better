...
public class BaitBucketRecipeWrapper implements ICraftingRecipeWrapper {
    private final List<List<ItemStack>> inputs;
    private final ItemStack output;

    public BaitBucketRecipeWrapper(Item bucket) {
        ItemStack rodStack = new ItemStack(bucket);
