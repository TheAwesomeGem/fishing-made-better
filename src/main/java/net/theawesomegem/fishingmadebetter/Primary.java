...
@Mod(modid = ModInfo.MOD_ID, version = ModInfo.VERSION, name = ModInfo.MOD_NAME, dependencies = "after:advanced-fishing;after:aquaculture", acceptableRemoteVersions = "[2.2.1,)")
